...
| **E-mail comercial** | Trocar `email` em [`src/data/contato.ts`](../src/data/contato.ts) | Enquanto começar com `contato@exemplo`, o e-mail é omitido do rodapé e do bloco de contato |
